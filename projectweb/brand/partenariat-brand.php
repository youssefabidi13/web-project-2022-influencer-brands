...
if(isset($_POST['submit'])){
    ...
    $status="non";
    $sql1="insert into `partenariat` (sender, receiver, contratname, from_date, to_date, montant, status) values ('$brand_username','$inf_username', '$contratname', '$from_date', '$to_date', '$montant', '$status') ";
